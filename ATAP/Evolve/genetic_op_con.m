function [ind,PP] = genetic_op_con(subproblems, index, domain, params, best_parameter)
...
% newpoint = selectpoints(1,:)+rand*(best_parameter-selectpoints(1,:))+params.F*(selectpoints(2,:)-selectpoints(3,:));
